...
function classes() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, descr, price, parentSelector) {
      ...
      this.parent = (_document = document).querySelector.apply(_document, [parentSelector].concat(classes));
      this.transfer = 11000;
      this.changeToUZS();
    }
...
function form(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    var prewModalDialog = document.querySelector(".modal__dialog");
...
function timer(id, deadLine) {
  ...
  function getTimeRemaining(endtime) {
    var days, hours, minutes, seconds; // bu o'zgaruvchi if else bilan time tugaganda hamma raqamlar 0 bo'lishu uchun yozildi
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])(".timer", "2023-12-31");
