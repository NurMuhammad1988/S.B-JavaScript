...
window.addEventListener("DOMContentLoaded", () => {
    ...
    // fetch('https://jsonplaceholder.typicode.com/todos/1')//fetch post method
    // .then(response => response.json())
    // .then(json => console.log(json))
});

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////FETCH AND A LOT OF DON'T UNDERSTAN METHODS
...
//             // const request = new XMLHttpRequest();
//             // request.open("POST", "server.php");//bu comentariyga olib turilipti chunku endi fetch fake api orqali qilinadi yani server.php orqali emas

//             // request.setRequestHeader("Content-Type", "application/json");//bu comentariyga olib turilipti chunku endi fetch fake api orqali qilinadi yani server.php orqali emas
...
//             // const json = JSON.stringify(obj);//bu comentariyga olib turilipti chunku endi fetch fake api orqali qilinadi yani server.php orqali emas

//             fetch("server.php", {//serverdan datani post qilish
//                 method: "POST",
//                 headers: {
...
//             // request.send(json);//bu comentariyga olib turilipti chunku endi fetch fake api orqali qilinadi yani server.php orqali emas
...
//             //         showThanksModal(msg.failure);
//             //     }
//             // });//bu comentariyga olib turilipti chunku endi fetch fake api orqali qilinadi yani server.php orqali emas
//         });
//     }
